-- BECOME YOU MVP Database Schema
-- Supabase tables for the assessment platform
...
CREATE TABLE orders (
  ...
  samcart_order_id VARCHAR(255) UNIQUE NOT NULL,
...
-- Plan outputs (structured JSON from Claude)
